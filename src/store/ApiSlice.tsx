...
query:({email,password})=>{
  ...
  listCenterUsers: builder.query({
    query: (options) => {
      const { limit, page, center_id, search_string, is_active, add_super_admin } = options;
      return {
        url: '', // Your API URL
        method: 'POST',
        body: {
...
export const{useLoginMutation,useRegenerateAccessTokenMutation,useListCenterUsersQuery}=usersApi;